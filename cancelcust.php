        ...
        if ($result->num_rows > 0) {
            ...
            if ($status === 'pending' || $status === 'confirmed') {
                ...
                if ($updateStmt->error) {
                    ...
                    echo '<script>window.location.href = "mainhtml.php";</script>'; // Redirect to customerbookinghtml.php
                ...
                echo '<script>window.location.href = "checkstatus.php";</script>'; // Redirect to customerbookinghtml.php
